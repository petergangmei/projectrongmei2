...
<nav style="color: white;" class=" navbar navbar-inverse navbar-fixed-top" role="navigation ">
    ...
    <!-- search engine form section -->

        <form style="width: 550px;" action="/search/peter" type='get' class="navbar-form navbar-left" role="search">
    ...
    <!-- search engine form section ens-->
...
<!--         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#">Separated link</a></li>
                ...
                <div style="color: white;" class="collapse navbar-collapse" id="app-navbar-collapse">
